...
public class Sentry {
    ...
    public static void SentryInit(ToolOptions options) {
        ...
        io.sentry.Sentry.configureScope(scope -> {
            if (options.getSourceTable() != null)
                scope.setContexts("sourceTable", options.getSourceTable());
            if (options.getSourceColumns() != null)
                scope.setContexts("sourceColumns", options.getSourceColumns());
            if (options.getSourceWhere() != null)
                scope.setContexts("sourceWhere", options.getSourceWhere());
            if (options.getSourceQuery() != null)
                scope.setContexts("sourceQuery", options.getSourceQuery());
            if (options.getSinkTable() != null)
                scope.setContexts("sinkTable", options.getSinkTable());
            ...
            if (options.getSinkColumns() != null)
                scope.setContexts("sinkColumns", options.getSinkColumns());
            ...
            if (options.getVersion() != null)
                scope.setTag("release.version", options.getVersion());
            if (options.getSinkFileformat() != null)
                scope.setTag("sink.file_format", options.getSinkFileformat());
