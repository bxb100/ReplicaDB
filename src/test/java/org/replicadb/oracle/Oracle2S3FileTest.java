...
@Testcontainers
class Oracle2S3FileTest {
    private static final Logger LOG = LogManager.getLogger(Oracle2S3FileTest.class);
    ...
    @Test
    void testOracle2S3FileComplete() throws ParseException, IOException {
        String s3Url = localstack.getS3ConnectionString() + "/oracle2s3_test.csv";
    ...
    @Test
    void testOracle2S3FileCompleteParallel() throws ParseException, IOException {
        String s3Url = localstack.getS3ConnectionString() + "/oracle2s3_parallel_test.csv";
